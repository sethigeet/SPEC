...
use spec_decode::{AsyncSpecPipeline, CandleLlama, Sampler, SamplerConfig, SpecDecoder};
...
// ─── Speculative Decoding Engine (candle-powered, synchronous) ───────────────
...
// ─── Async Speculative Decoding Engine (candle-powered, multi-threaded) ──────
...
/// ```
#[pyclass]
struct AsyncSpecDecodingEngine {
